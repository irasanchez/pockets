...
const config = {
  ...
  theme: {
    ...
    boxShadow: {
      ...
      DEFAULT: '2px 2px 0px 2px rgba(13, 40, 39, 1)',
      md: '3px 3px 0px 3px rgba(19, 38, 70, 1)',
      lg: '5px 5px 0px 5px rgba(19, 38, 70, 1)',
      xl: '7px 7px 0px 7px rgba(19, 38, 70, 1)',
      '2xl': '9px 9px 0px 9px rgba(19, 38, 70, 1)',
