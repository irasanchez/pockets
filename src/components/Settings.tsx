...
export default function Settings() {
  return (
    ...
    >
      ...
      <Typography level="p" sx={{ mb: 1 }}>
        Most apps collect your data in order to provide you services. This app is one of them, and pages like this are one way of gathering necessary data. <Link to="/privacy">Go here</Link> to see how your data is used.
      </Typography>
